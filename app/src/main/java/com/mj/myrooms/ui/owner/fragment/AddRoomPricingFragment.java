...
public class AddRoomPricingFragment extends BaseFragment implements View.OnClickListener {
    private final String TAG = getClass().getSimpleName();
    private Activity mActivity;
    private AddRoomOw parentActivity;
    private FragmentAddRoomPricingBinding layoutBinding;
...
//    private CustomerModel object_customer;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        layoutBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_add_room_pricing, container, false);
